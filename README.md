...
* **[CortexWAF](https://github.com/ellasypark/CortexWAF)**  | *AWS AI Agent Hackathon winner* AWS WAF log analysis and rule management with a React dashboard and a separate Bedrock / Claude event-triage pipeline. Planned: application-aware RAG, evidence-backed recommendations, and analyst-reviewed rule updates. 
